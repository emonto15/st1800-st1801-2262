...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE 
LOCATION 's3://emontoya-datalake/datasets/onu/hdi/'
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE 
LOCATION 's3://emontoya-datalake/datasets/onu/export/'
```
...
CREATE EXTERNAL TABLE docs (line STRING) 
STORED AS TEXTFILE 
LOCATION 's3://emontoya-datalake/datasets/gutenberg-small/';
```
...
```
En 34.236.231.151, se tiene Mysql con (actualice la IP con el valor real de acuerdo a su contexto):
...
$ sqoop import --connect jdbc:mysql://34.236.231.151:3306/cursodb --username curso --password curso --table employee --target-dir /user/hadoop/employee -m 1
...
$ sqoop import-all-tables --connect jdbc:mysql://34.236.231.151:3306/cursodb --username curso --password curso --warehouse-dir /user/hadoop/cursodb -m 1
...
```
$ sqoop export --connect jdbc:mysql://34.236.231.151:3306/cursodb --username curso -P --table username_employee2 --export-dir /user/hadoop/mysqlOut
```
